...
const unsigned int SCR_HEIGHT = 1036;
...
int main()
{
    ...
    ffmpeg_encoder_start(&c, &file, "model_loading_light_noraml_demo_v1.mp4", &frame, AV_CODEC_ID_MPEG4, 24, SCR_WIDTH, SCR_HEIGHT);
#endif
...
#define RATOTE_START_TIME 6
        ...
        if (output_formats & FFMPEG_BIT) {
            ...
            //--                SCR_WIDTH, SCR_HEIGHT, 4,
            //--                pixels + (SCR_WIDTH * 4 * (SCR_HEIGHT - 1)),
            //--                -SCR_WIDTH * 4);
        }
        nframes++;
#endif
