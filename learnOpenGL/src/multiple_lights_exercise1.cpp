...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("./src/shaders/6.multiple_lights.vs", "./src/shaders/6.multiple_lights.fs");
    Shader lightCubeShader("./src/shaders/6.light_cube.vs", "./src/shaders/6.light_cube.fs");
